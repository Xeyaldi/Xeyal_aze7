...
async def chatbot_logic(client, message):
    ...
    # --- XÜSUSİ CAVABLAR ---
    if msg_text == "salam":
        return await message.reply_text("salam oglan")
    ...
    try:
        ...
        if random.random() < 0.20:
            ...
            res = cur.fetchone()
            # Bazada söz yoxdursa hazır siyahıdan götür
